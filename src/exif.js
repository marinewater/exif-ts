...
export class Exif {
    ...
    _readIPTCData(startOffset, sectionLength) {
        const data = {};
        let fieldValue;
        let fieldName;
        let dataSize;
    ...
    _readTags(tiffStart, dirStart, strings, bigEnd) {
    ...
    _readThumbnailImage(tiffStart, firstIFDOffset, bigEnd) {
        // get the IFD1 offset
    ...
    _getNextIFDOffset(dirStart, bigEnd) {
